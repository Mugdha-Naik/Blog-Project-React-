...
function Header() {
  ...
  return (
    <header className=' mb-8 py-3 shadow bg-gray-500 rounded-lg'>
        <Container>
            <nav className='flex'>
                <div className='mr-4 '>
                    <Link to='/'>
                ...
                <ul className='flex ml-auto'>
                    ...
                    item.active ? (
                        <li key={item.name}>
                            <Link
                                to={item.slug}
                                className="inline-block px-6 py-2 duration-200 hover:bg-blue-100 rounded-full text-lg font-medium"
                            >
                                {item.name}
                            </Link>
                        </li>
